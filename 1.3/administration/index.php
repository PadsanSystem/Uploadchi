			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-xs-9 text-right">
							<div class="huge"><?php echo number_format($result_files_count); ?></div>
				...
				<a href="#">
					<div class="panel-footer">
						<span class="pull-left">View uploaded files</span>
			...
			<div class="panel panel-green">
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-xs-9 text-right">
							<div class="huge"><?php echo number_format($result_files_views_count); ?></div>
							<div>View files</div>
						</div>
					</div>
				</div>
			...
			<div class="panel panel-yellow">
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-xs-9 text-right">
							<div class="huge"><?php echo number_format($result_users_count); ?></div>
							<div>Users</div>
						</div>
					</div>
				</div>
