	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="pull-right">
				<img src="images/location_corporation.jpg" alt="Location of PadsanSystem co" class="img-responsive img-thumbnail">
			</div>
			<blockquote>
				<address>
			...
			<img src="images/facebook.png" alt="facebook" class="img-thumbnail">
			<img src="images/twitter.png" alt="twitter" class="img-thumbnail">
			<img src="images/google.png" alt="google" class="img-thumbnail">
		</div>
	</div>
</div>
<?php
