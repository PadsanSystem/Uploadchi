					...
					<form name="form_local_upload" class="form-horizontal" role="form" method="post" action="<?php echo BASEDIR.'upload.php'; ?>" enctype="multipart/form-data">
						...
						<div class="form-group">
							<div class="col-lg-4 col-lg-offset-4 text-center">
								<button id="send_file" name="send_file" type="submit" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-cloud-upload"></span>&nbsp;&nbsp;Upload Files</button>
							</div>
						</div>
					</form>
				</div>
			...
			<div class="panel panel-success" style="border-top-left-radius:0">
				<div class="panel-body">
					<form name="form_remote_upload" class="form-horizontal" role="form" method="post" action="<?php echo BASEDIR.'upload.php'; ?>">
						...
						<div class="form-group">
							<div class="col-lg-4 col-lg-offset-4 text-center">
								<button id="send_file" name="send_file" type="submit" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-cloud-upload"></span>&nbsp;&nbsp;Transfer Links</button>
							</div>
						</div>
					</form>
				</div>
