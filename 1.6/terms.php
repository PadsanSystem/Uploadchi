	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<ol>
				...
				<li>
					Uploadchi and Leecher is not liable for your images, videos or files or any lost business due to the unavailability or loss of the website. We make no claims of future reliability in serving, hosting or storing your images, videos or files.
				</li>
			</ol>
			<p>
			Uploadchi and Leecher is commited to cooperate with any and all legal authorities if an investigation should arise. 
		</div>
	</div>
</div>
<?php
